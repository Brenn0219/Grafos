...
/// @brief Envia um elemento para a pilha especificada por stack. O novo elemento contém um ponteiro para dados, então a memória referenciada pelos dados deve permanecer válida enquanto o elemento permanecer no pilha. É responsabilidade do chamador gerenciar o armazenamento associado aos dados. Complexidade - O(1).
...
/// @brief Retira um elemento da pilha especificada por stack. Ao retornar, os dados apontam para os dados armazenados em o elemento que foi exibido. É responsabilidade do chamador gerenciar o armazenamento associado com os dados. Complexidade - O(1).
/// @param stack ponteiro para uma pilha
